...
history_text = '# PHP 8.5 consolidated historical dispositions\n\nGenerated by `tools/php85-certification.py`. Original reports remain historical; [completeness.md](completeness.md) defines the current claim.\n\n'
...
input_paths = ['.gitattributes', 'tools/php85-certification.py', 'tools/php85-source-correspondence.py', 'tools/grammar-release.py',

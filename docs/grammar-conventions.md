...
PHP conformance runner. Phase 3 adds a separate project-owned PHP lexical layer
that classifies PHP source into repository tokens without depending on the
